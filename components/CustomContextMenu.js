...
export default function CustomContextMenu(props) {
  ...
  return (
    <div
      ...
      {/* 菜单内容 */}
      <div className='rounded-2xl w-52 dark:hover:border-white-600 bg-white dark:bg-[#040404] dark:text-gray-200 dark:border-gray-600 p-3 border drop-shadow-lg flex-col duration-300 transition-colors'>
        {/* 顶部导航按钮 */}
