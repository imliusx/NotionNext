...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'aicyber', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple,ai
  ...
  theme: process.env.BLOG_THEME || 'aicyber',
  themes: ['hexo', 'commerce', 'aicyber'], // 添加 aicyber 到主题列表
