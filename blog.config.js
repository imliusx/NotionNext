...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'liustack', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple,ai
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '𝕷𝖎𝖚𝕾𝖙𝖆𝖈𝖐𝖘', // 您的昵称 
  ...
  ...require('./public/css/code.config'), // 网站代码块样式
