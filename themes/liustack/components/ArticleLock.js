...
export const ArticleLock = props => {
  ...
  return <div id='container' className='w-full flex justify-center items-center h-96 '>
    <div className='text-center space-y-3'>
      <div className='font-nomal dark:text-gray-300 text-black'>{locale.COMMON.ARTICLE_LOCK_TIPS}</div>
      <div className='flex mx-4'>
        <input id="password" type='password'
            ...
            className='outline-none w-full text-sm pl-5 rounded-l transition focus:shadow-lg  font-normal leading-10 bg-gray-100 dark:bg-gray-500'>
        </input>
